...
public class Patient {
	    ...
	    public Patient( String fname, String lname, String bday, String phoneNumber, String healthHistory,String insuranceID,String pharmacy, int totalCAC, int lmValue, int ladValue, int lcxValue, int rdaValue, int pdaValue) {
